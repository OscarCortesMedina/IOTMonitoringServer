...
const char ssid[] = "FAMILIA MEDINA."; // TODO cambiar por el nombre de la red WiFi
// Contraseña de la red WiFi
const char pass[] = "familiaMedina6K"; // TODO cambiar por la contraseña de la red WiFi
...
const char MQTT_HOST[] = "3.92.191.183"; // TODO Reemplace ip.maquina.mqtt por la IP del bróker MQTT que usted desplegó. Ej: 192.168.0.1
...
void mqtt_connect()
{
  ...
  while (!client.connected()) {
    ...
    if (client.connect(MQTT_USER, MQTT_USER, MQTT_PASS)) {
      ...
      lcdErrorConnectingToMQTT(String(state));
...
void lcdErrorConnectingToMQTT(String error) {
   lcd.clear();
  // Imprimir
  lcd.setCursor(0, 0);
